    ...
    <section id="admin-index">
        <nav class="d-flex justify-content-start align-items-center container">
            ...
            <ul class="d-flex justify-content-between align-items-center">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Route::currentRouteName() == 'admin.textures.index' ? 'active' : '' }}" href="{{route('admin.textures.index')}}">Textures</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ Route::currentRouteName() == 'admin.brands.index' ? 'active' : '' }}" href="{{route('admin.brands.index')}}">Brands</a>
                </li>
                {{-- <li class="nav-item">
            ...
            <table class="table table-striped">
                ...
                @foreach($products as $product)
                        <tr>
                            ...
                            <td>{{$product->brands && count($product->brands) > 0 ? count($product->brands) : 0}}</td>
                            <td>{{$product->textures && count($product->textures) > 0 ? count($product->textures) : 0}}</td>
